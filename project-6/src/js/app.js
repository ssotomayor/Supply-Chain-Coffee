App = {
    ...
    getMetaskAccountID: function () {
        console.log('getMetaskAccountID');
        web3 = new Web3(App.web3Provider);

        // Retrieving accounts
        web3.eth.requestAccounts().then((res) => App.metamaskAccountID = res[0]);
    },
    ...
    addFarmerRole: async (event) => {
        ...
        try {
            let result = await supplyChain.addFarmer(App.newFarmerId, { from: App.metamaskAccountID, gas: 2500000 });
    ...
    addDistributorRole: async (event) => {
        ...
        try {
            let result = await supplyChain.addDistributor(App.newDistributorId, { from: App.metamaskAccountID, gas: 2500000 });
            $("#ftc-item").text(result);
    ...
    addRetailerRole: async (event) => {
        ...
        try {
            let result = await supplyChain.addRetailer(App.newRetailerId, { from: App.metamaskAccountID, gas: 2500000 });
            $("#ftc-item").text(result);
    ...
    addConsumerRole: async (event) => {
        ...
        try {
            let result = await supplyChain.addConsumer(App.newConsumerId, { from: App.metamaskAccountID, gas: 2500000 });
            $("#ftc-item").text(result);
